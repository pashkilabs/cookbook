...
export const SEED_CATALOG: CatalogItem[] = [
  ...
  { key: "mozzarella", containers: { bag: 454 }, names: ["shredded mozzarella", "grated mozzarella", "mozzarella"],
    aisle: "Dairy", dimension: "weight", gramsPerCup: 113,
  ...
  { key: "greek-yogurt", containers: { tub: 907 }, names: ["greek yogurt", "greek yoghurt", "strained yogurt"],
    aisle: "Dairy", dimension: "weight", gramsPerCup: 245,
  ...
  { key: "cream-cheese", containers: { block: 227 }, names: ["cream cheese"], aisle: "Dairy", dimension: "weight", gramsPerCup: 232,
  ...
  { key: "feta", containers: { block: 200 }, names: ["feta"], aisle: "Dairy", dimension: "weight", gramsPerCup: 150,
  ...
  { key: "shrimp", containers: { bag: 454 }, names: ["shrimp", "prawns"], aisle: "Meat & Seafood", dimension: "weight",
    packages: [{ label: "1 lb bag", amount: 454 }] , kcalPer100g: 85, energyFdcId: "175179"},

  // ---- Produce ----
  { key: "onion", containers: { bag: 6 }, names: ["yellow onion", "white onion", "red onion", "onions", "onion"],
  ...
  { key: "lemon", containers: { bag: 5 }, names: ["lemon", "lemons"], aisle: "Produce", dimension: "count",
    packages: [{ label: "loose", amount: 1 }, { label: "bag of 5", amount: 5 }] , gramsEach: 58, kcalPer100g: 29, energyFdcId: "167746"},
  { key: "lime", containers: { bag: 5 }, names: ["lime", "limes"], aisle: "Produce", dimension: "count",
  ...
  { key: "tomatoes", containers: { container: 12 }, names: ["roma tomato", "roma tomatoes", "cherry tomatoes", "cherry tomato", "tomatoes", "tomato"],
    aisle: "Produce", dimension: "count",
  ...
  { key: "avocado", containers: { bag: 4 }, names: ["avocado", "avocados"], aisle: "Produce", dimension: "count",
  ...
  { key: "parsley", names: ["fresh parsley", "parsley"], aisle: "Produce", dimension: "bunch",
    packages: [{ label: "1 bunch", amount: 1 }] },
  { key: "basil", containers: { packet: 1 }, names: ["fresh basil", "basil"], aisle: "Produce", dimension: "bunch",
  ...
  { key: "pasta", containers: { box: 454 }, names: ["spaghetti", "rigatoni", "fettuccine", "linguine", "penne", "pasta"],
    aisle: "Pantry", dimension: "weight", packages: [{ label: "1 lb box", amount: 454 }] , kcalPer100g: 371, energyFdcId: "169736"},
  { key: "canned-tomatoes", containers: { tin: 400 }, names: ["crushed tomatoes", "diced tomatoes", "canned tomatoes", "chopped tomatoes", "tomato sauce", "passata"],
  ...
  { key: "dry-yeast", names: ["dry yeast", "active dry yeast", "instant yeast", "yeast"],
    aisle: "Baking", dimension: "weight", containers: { package: 7, packet: 7, envelope: 7, jar: 113 },
    packages: [{ label: "3-packet strip", amount: 21 }, { label: "4 oz jar", amount: 113 }],
    kcalPer100g: 325 },
  { key: "tomato-paste", containers: { can: 170 }, names: ["tomato paste", "tomato puree"], aisle: "Pantry", dimension: "weight", gramsPerCup: 260, canSize: 170,
    packages: [{ label: "6 oz can", amount: 170 }] },
  { key: "sun-dried-tomatoes", containers: { jar: 227 }, names: ["sun dried tomatoes", "sun-dried tomatoes"], aisle: "Pantry", dimension: "weight", gramsPerCup: 110,
    packages: [{ label: "8 oz jar", amount: 227 }] },
  { key: "broth", containers: { can: 429 }, names: ["chicken broth", "chicken stock", "vegetable broth", "vegetable stock", "beef broth", "broth", "stock"],
  ...
  { key: "coconut-milk", containers: { can: 400, tin: 400 }, names: ["coconut milk"], aisle: "Pantry", dimension: "volume", canSize: 400,
    packages: [{ label: "13.5 oz can", amount: 400 }] },
  { key: "beans", containers: { can: 425, tin: 400 }, names: ["black beans", "kidney beans", "chickpeas", "cannellini beans", "pinto beans"],
  ...
  { key: "honey", containers: { jar: 355 }, names: ["honey"], aisle: "Pantry", dimension: "volume",
